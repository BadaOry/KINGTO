...
<section>
	...
	<aside class="side_nav">
		<ul>
			<li><a onclick="location.href='${pagecontext.request.contestPath}/my_page/recent?page=1'" style="background-color: rgb(220, 220, 220);">최신피드</a></li>
	...
	<div id="content">
		...
		<div id="pageBar">
			<!-- 맨 처음으로 -->
			<button
				onclick="location.href='${ pagecontext.request.contextPath }/my_page/recent?page=1'">&lt;&lt;</button>

			<!-- 이전 페이지로 -->
			<button
				onclick="location.href='${ pagecontext.request.contextPath }/my_page/recent?page=${ pageInfo.prevPage }'">&lt;</button>
			...
			<c:forEach begin="${ pageInfo.startPage }"
				...
				<c:if test="${ status.current != pageInfo.currentPage }">
					<button
						onclick="location.href='${ pagecontext.request.contextPath }/my_page/recent?page=${ status.current }'">${ status.current }</button>
				</c:if>
			</c:forEach>
			...
			<!-- 다음 페이지로 -->
			<button
				onclick="location.href='${ pagecontext.request.contextPath }/my_page/recent?page=${ pageInfo.nextPage }'">&gt;</button>

			<!-- 맨 끝으로 -->
			<button
				onclick="location.href='${ pagecontext.request.contextPath }/my_page/recent?page=${ pageInfo.maxPage }'">&gt;&gt;</button>
		</div>
