...
<section>
	...
	<aside class="side_nav">
		<ul>
            ...
            <li><a onclick="location.href='${pagecontext.request.contestPath}/my_page/myFeed?page=1'" style="background-color: rgb(220, 220, 220);">내 피드</a></li>
    ...
    <div id="content" >
    	...
    	<a onclick="location.href='${pagecontext.request.contestPath}/my_page/feed_write'">
