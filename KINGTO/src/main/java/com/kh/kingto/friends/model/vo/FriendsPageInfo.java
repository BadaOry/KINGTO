...
public class FriendsPageInfo {
	 ...
	 * @param pageLimit 한 페이지에 보이는 페이지의 수 = 10
	 * @param listCount 전체 리스트(회원)의 수
	 * @param listLimit 한 페이지에 표시될 회원의 수 = 6
	 */
	public FriendsPageInfo(int currentPage, int pageLimit, int listCount, int listLimit) {
	...
	/** 	
	 * @return 전체 페이지 중 가장 마지막 페이지(현제 전체 회원 수로 몇 페이지까지 나오는지)
	 */
	public int getMaxPage() {
		/*
		 	listCount = 100, listLimit = 6
		 	100 / 6 = 16.6		=> 17페이지
		 	101 / 6 = 16.8		=> 17페이지
		 	103 / 6 = 17.2		=> 18페이지
		 	109 / 6 = 18.2		=> 19페이지
	...
	/**
	 * 
	 * @return 페이지의 시작 리스트  (1페이지에는 1~6번 회원, 2페이지에는 7~12번 회원 ..)
	 */ 	
	...
	/**
	 * 
	 * @return 페이지의 마지막 리스트 (1페이지에는 1~6번글, 2페이지에는 7~12번글 ..)
	 */  	
